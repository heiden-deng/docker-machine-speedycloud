...
//func ChooseVersion(client *speedycloud.ProviderClient, recognized []*Version) (*Version, string, error) {
...
//
//	var resp response
//	_, err := client.Request("GET", client.IdentityBase, speedycloud.RequestOpts{
//		JSONResponse: &resp,
//		OkCodes:      []int{200, 300},
//	})
//
